...
$sql = "SELECT * FROM `programming_quiz_result` WHERE Email='$email'";
...
<body>
    ...
    <div class="container">
        ...
        <button class="start btn btn-dark" <?php if ($row) {
                                                $disabled = "yes"; ?> disabled <?php   } ?>><a href="question.php?n=1">Start Quiz</a></button>
        ...
        if ($disabled == "yes") {
            ...
            echo "<center>";
            echo "<button class='btn btn-primary'><a href='php_verify.php?e=$email'> Verify Answers</a></button>";
            echo "</center>";
        }
        ?>
    </div>
