...
// Query for questions
$query = "SELECT * FROM java_mcqs_question WHERE Question_Number = $number";
// Get the question
$results = mysqli_query($conn, $query);
$question = mysqli_fetch_assoc($results);

// Get Choices
$query_c = "SELECT * FROM java_mcqs_choices WHERE Question_Number = $number";
$choice = mysqli_query($conn, $query_c);
// Get Total Questions
$query_q = "SELECT * FROM java_mcqs_question";
...
<body>
    ...
    <main>
        <div class="container">
            ...
            <form action="java_process.php" method="POST">
                <ul class="choices">
                    <?php
